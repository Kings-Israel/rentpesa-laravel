...
{{--                <img src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('assets/img/avatars/1.png') }}" alt class="h-auto rounded-circle">--}}
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile.show', auth()->user()) : url('pages/profile-user') }}">
                  <div class="d-flex">
{{--                    <div class="flex-shrink-0 me-3">--}}
{{--                      <div class="avatar avatar-online">--}}
{{--                        <img src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('assets/img/avatars/user.png') }}" alt class="h-auto rounded-circle">--}}
{{--                      </div>--}}
{{--                    </div>--}}
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted">{{ Str::ucfirst(auth()->user()->getRoleNames()[0]) }}</small>
                    </div>
                  </div>
                </a>
              </li>
