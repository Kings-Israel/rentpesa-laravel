              ...
              <div class="user-profile-info">
                ...
                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                  <li class="list-inline-item">
                    <i class='ti ti-color-swatch'></i> {{ Str::ucfirst($user->getRoleNames()[0]) }}
                  </li>
                  <li class="list-inline-item">
                    <i class='ti ti-calendar'></i> Joined {{ $user->created_at->format('M Y') }}</li>
                </ul>
              </div>
            </div>
          </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        @role('landlord')
          <li class="nav-item"><a class="nav-link" href="{{url('pages/profile-projects')}}"><i class='ti-xs ti ti-layout-grid me-1'></i> Properties</a></li>
          <li class="nav-item"><a class="nav-link" href="{{url('pages/profile-connections')}}"><i class='ti-xs ti ti-link me-1'></i> Agents</a></li>
        @endrole
        @role('agent')
          <li class="nav-item"><a class="nav-link" href="{{url('pages/profile-projects')}}"><i class='ti-xs ti ti-layout-grid me-1'></i> Properties</a></li>
        @endrole
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <ul class="list-unstyled mb-4 mt-3">
            ...
            <li class="d-flex align-items-center mb-3"><i class="ti ti-crown"></i><span class="fw-bold mx-2">Role:</span> <span>{{ Str::ucfirst($user->getRoleNames()[0]) }}</span></li>
          </ul>
