...
@section('content')
  ...
  <h4 class="fw-bold py-3 mb-2">
    <span class="text-muted fw-light"><a href="{{ route('properties.index') }}">Properties</a> /</span> Edit Property / {{ $property->name }}
  </h4>
        ...
        <div id="property-details" class="content">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" id="plName" name="plName" class="form-control" placeholder="Enter Property Name" value="{{ $property->name }}" />
              @error('plName')
            ...
            <div class="col-sm-6">
              ...
              <select id="plPropertyType" name="plPropertyType" class="select2 form-select" data-allow-clear="true">
                ...
                @foreach($property_types as $property_type)
                  <option value="{{ $property_type->id }}" @if($property->property_type_id == $property_type->id) selected @endif>{{ $property_type->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-sm-6">
              ...
              <select id="plPropertyCounty" name="plPropertyCounty" class="select2 form-select" data-allow-clear="true" onchange="getSubcounties()">
                ...
                @foreach($counties as $county)
                  <option value="{{ $county->id }}" @if($property->county_id == $county->id) selected @endif data-subcounties="{{ $county->subcounties }}">{{ $county->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-sm-6">
              ...
              <select id="plPropertySubcounty" name="plPropertySubcounty" class="select2 form-select" data-allow-clear="true">
                ...
                @foreach($subcounties as $subcounty)
                  <option value="{{ $subcounty->id }}" @if($property->subcounty_id == $subcounty->id) selected @endif>{{ $subcounty->name }}</option>
                @endforeach
              </select>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" id="plPropertyStreet" name="plPropertyStreet" class="form-control" placeholder="Enter Road/Street" value="{{ $property->street }}" />
              @error('plStreet')
              <span class="text-danger">{{ $message }}</span>
              @enderror
            </div>
            <div class="col-sm-6">
              ...
              <input type="text" id="plNearestLandmark" name="plNearestLandmark" class="form-control" placeholder="Nr. Hard Rock Cafe" value="{{ $property->nearest_landmark }}" />
            ...
            <div class="col-lg-12">
              ...
              <textarea id="plAddress" name="plPropertyAddress" class="form-control" rows="2" placeholder="12, Business Park">{{ $property->address }}</textarea>
        ...
        <div id="agreement-details" class="content">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="date" id="plAgreementStartDate" name="plAgreementStartDate" class="form-control" value="{!! $property->agreement_start_date !!}" />
            ...
            <div class="col-sm-6">
              ...
              <input type="date" id="plAgreementEndDate" name="plAgreementEndDate" class="form-control" value="{{ $property->agreement_end_date }}" />
            ...
            <div class="col-sm-6">
              ...
              <select id="plRentPaymentDay" name="plRentPaymentDay" class="select2 form-select" data-allow-clear="true">
                ...
                @endphp
                @for($i = 1; $i <= 31; $i++)
                  <option value="{{ $nf->format($i).' Day of the Month' }}" @if($property->rent_payment_day === $nf->format($i).' Day of the Month') selected @endif>{{ $nf->format($i) }} Day of the Month</option>
                @endfor
              </select>
            ...
            <div class="col-sm-6">
              ...
              <input type="number" id="plLatePaymentCharge" name="plLatePaymentCharge" class="form-control" placeholder="10" value="{{ $property->late_payment_charge }}" />
            ...
            <div class="col-sm-12">
              ...
              <input type="file" id="basic-default-upload-file" name="plCoverImage" accept=".jpg,.jpeg,.png" class="form-control" />
              @error('plCoverImage')
              <span class="text-danger">{{ $message }}</span>
              @enderror
            </div>
            <div class="col-lg-12">
              ...
              <textarea id="plOtherDetails" name="plOtherDetails" class="form-control" rows="2">{{ $property->other_details }}</textarea>
              @error('plOtherDetails')
              <span class="text-danger">{{ $message }}</span>
              @enderror
            </div>
            <div class="col-12 d-flex justify-content-between mt-4">
              <a class="btn btn-label-secondary" href="{{ route('properties.show', $property) }}"><span class="align-middle d-sm-inline-block d-none">Cancel</span></a>
              <button type="submit" class="btn btn-success btn-submit btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-1">Update</span><i class="ti ti-check ti-xs"></i></button>
            </div>
          </div>
        </div>
      </form>
