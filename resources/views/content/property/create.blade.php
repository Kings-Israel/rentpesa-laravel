      ...
      <form id="wizard-property-listing-form" onSubmit="return false">
        ...
        <div id="property-details" class="content">
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              <label class="form-label" for="plCounty">County</label>
              <select id="plCounty" name="plCounty" class="select2 form-select" data-allow-clear="true" onchange="getSubcounties()">
            ...
            <div class="col-sm-6">
              <label class="form-label" for="plSubcounty">Sub-county</label>
              <select id="plSubcounty" name="plSubcounty" class="select2 form-select" data-allow-clear="true">
                <option value="">Select Sub county</option>
              </select>
            </div>
            <div class="col-sm-6">
              <label class="form-label" for="plStreet">Road/Street</label>
              <input type="text" id="plName" name="plStreet" class="form-control" placeholder="Enter Road/Street" />
            </div>
            <div class="col-sm-6">
