...
@section('content')
  ...
  <div class="row">
        ...
        <div class="swiper-wrapper">
          @if(count($properties) > 0)
            @foreach($properties->take(3) as $property)
              ...
              <div class="row">
                <div class="col-12">
                  <h5 class="text-white mb-0 mt-2">View Property Analytics</h5>
                </div>
                <div class="row">
                  <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                    <h6 class="text-white mt-0 mt-md-3 mb-3">{{ $property->name }}</h6>
                    <div class="row">
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          <li class="d-flex mb-4 align-items-center">
                            <p class="mb-0 fw-semibold me-2 website-analytics-text-bg">{{ $property->units->count() }}</p>
                            <p class="mb-0">Unit(s)</p>
                          </li>
                          <li class="d-flex align-items-center mb-2">
                            <p class="mb-0 fw-semibold me-2 website-analytics-text-bg">{{ count($property->occupiedUnits()) }}</p>
                            <p class="mb-0">Tenant(s)</p>
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          @else
            <div class="swiper-slide">
              <div class="row">
                <div class="col-12">
                  <h5 class="text-white mb-0 mt-2">View Property Analytics</h5>
                  <small>How Much is occupied</small>
                </div>
                <div class="row">
                  <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          <li class="d-flex mb-4 align-items-center">
                            <p class="mb-0 fw-semibold me-2 website-analytics-text-bg">100</p>
    ...
    <!-- Properties Units Value Overview -->
    <div class="col-lg-6 col-sm-6 mb-4">
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            <small class="d-block mb-1 text-muted">Properties Units Value Overview</small>
          </div>
          <h4 class="card-title mb-1">Ksh.{{ number_format($total_units_value) }}</h4>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-4">
              ...
              <h5 class="mb-0 pt-1 text-nowrap">Ksh.{{ number_format($occupied_units_value) }}</h5>
              <small class="text-muted">{{ count($occupied_units) }} units occupied</small>
            </div>
            <div class="col-4">
            ...
            <div class="col-4 text-end">
              ...
              <h5 class="mb-0 pt-1 text-nowrap ms-lg-n3 ms-xl-0">Ksh.{{ number_format($vacant_units_value) }}</h5>
              <small class="text-muted">{{ count($units) - count($occupied_units) }} units vacant</small>
            </div>
          </div>
          <div class="d-flex align-items-center mt-1">
            <div class="progress w-100" style="height: 8px;">
              <div class="progress-bar bg-info" style="width: {{ $occupied_units_percentage }}%" role="progressbar" aria-valuenow="{{ $occupied_units_percentage }}" aria-valuemin="0" aria-valuemax="100"></div>
              <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $vacant_units_percentage }}%" aria-valuenow="{{ $vacant_units_percentage }}" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Total Occupancy Tracker -->
    <div class="col-md-6 mb-4">
      <div class="card">
        <div class="card-header d-flex justify-content-between pb-0">
          <div class="card-title mb-0">
            <h5 class="mb-0">Occupancy Report</h5>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-4 col-md-12 col-lg-4">
              ...
              <ul class="p-0 m-0">
                <li class="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1">
                  ...
                  <div>
                    <h6 class="mb-0 text-nowrap">Vacant Units</h6>
                    <small class="text-muted">{{ count($units) - count($occupied_units) }}</small>
                  </div>
                </li>
                <li class="d-flex gap-3 align-items-center mb-lg-3 pb-1">
                  <div class="badge rounded bg-label-info p-1"><i class="ti ti-circle-check ti-sm"></i></div>
                  <div>
                    <h6 class="mb-0 text-nowrap">Occupied Units</h6>
                    <small class="text-muted">{{ count($occupied_units) }}</small>
                  </div>
                </li>
              </ul>
            </div>
            <div class="col-12 col-sm-8 col-md-12 col-lg-8">
              <span id="occupiedUnitsTracker" style="display: none">{{ $occupied_units_percentage }}</span>
